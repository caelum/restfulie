...
context Restfulie::Client::HTTP do
  ...
  context "HTTP Base" do
    ...
    it "should get and respond 200 code" do
      @client.get("/test")[2].code.to_i.should == 200
    end

    it "should put and respond 200 code" do
      @client.put("/test", "test")[2].code.to_i.should == 200
    end

    it "should delete and respond 200 code" do
      @client.delete("/test")[2].code.to_i.should == 200
    end

    it "should head and respond 200 code" do
      @client.head("/test")[2].code.to_i.should == 200
    end
    ...
    it "should post! and respond 201 code" do
      @client.post!("/test", "test")[2].code.to_i.should == 201
    end
  ...
  context 'HTTP Builder' do
    ...
    context "On GET" do
      ...
      it "should respond to 200 code" do
        builder.at('/test/200').get[2].code.to_i.should == 200
      end
      
      it "should accepts and respond to 200 code on xml" do
        builder.at('/test/200').accepts('application/xml').get[2].code.to_i.should == 200
      end
      
      it "should respond to 200 code as xml" do
        builder.at('/test/200').as('application/xml').get[2].code.to_i.should == 200
      end
      
      it "should accept language and respond 200" do
        builder.at('/test/200').with('Accept-Language' => 'en').get[2].code.to_i.should == 200
      end
      
      it "should respond 200 code as xml and accept atom and language" do
        builder.at('/test/200').as('application/xml').accepts('application/atom+xml').with('Accept-Language' => 'en').get[2].code.to_i.should == 200
      end
    ...
    context "On PUT" do
      it "should respond to 200 code" do
        builder.at("/test").put("test")[2].code.to_i.should == 200
      end
      
      it "should accepts xml and respond to 200 code" do
        builder.at('/test').accepts('application/xml').put("test")[2].code.to_i.should == 200
      end
      
      it "should respond to 200 code as xml" do
        builder.at('/test').as('application/xml').put("test")[2].code.to_i.should == 200
      end
      
      it "should include accept language and respond 200" do
        builder.at('/test').with('Accept-Language' => 'en').put("test")[2].code.to_i.should == 200
      end
      
      it "should respond 200 code as xml and accepts xml with en language" do
        builder.at('/test').as('application/xml').accepts('application/atom+xml').with('Accept-Language' => 'en').put("test")[2].code.to_i.should == 200
      end
    ...
    context "On DELETE" do
      ...
      it "should respond 200 code" do
        builder.at("/test").delete[2].code.to_i.should == 200
      end
      
      it "should accepts xml and respond 200 code" do
        builder.at('/test').accepts('application/xml').delete[2].code.to_i.should == 200
      end
      
      it "as xml should respond 200 code" do
        builder.at('/test').as('application/xml').delete[2].code.to_i.should == 200
      end
      
      it "should respond 200 code with accept language en" do
        builder.at('/test').with('Accept-Language' => 'en').delete[2].code.to_i.should == 200
      end
      
      it "should respond 200 code as xml accepts atom+xml with accept language en" do
        builder.at('/test').as('application/xml').accepts('application/atom+xml').with('Accept-Language' => 'en').delete[2].code.to_i.should == 200
      end
    ...
    context "On HEAD" do
      ...
      it "should respond 200 code" do
        builder.at("/test").head[2].code.to_i.should == 200 
      end
      
      it "should respond 200 code and accepts xml" do
        builder.at('/test').accepts('application/xml').head[2].code.to_i.should == 200 
      end
      
      it "should respond 200 code as xml" do
        builder.at('/test').as('application/xml').head[2].code.to_i.should == 200
      end
      
      it "should respond 200 code with accept language en" do
        builder.at('/test').with('Accept-Language' => 'en').head[2].code.to_i.should == 200
      end
      
      it "should respond 200 code as xml and accepts atom+xml with accepts language en" do
        builder.at('/test').as('application/xml').accepts('application/atom+xml').with('Accept-Language' => 'en').head[2].code.to_i.should == 200
      end
  ...
  context 'RequestHistory' do
    ...
    it "should remember last requests" do
      @builder.at('/test').accepts('application/atom+xml').with('Accept-Language' => 'en').get[2].code.to_i.should == 200
      @builder.at('/test').accepts('text/html').with('Accept-Language' => 'pt-BR').head[2].code.to_i.should == 200
      @builder.at('/test').as('application/xml').with('Accept-Language' => 'en').post('test')[2].code.to_i.should == 201
      @builder.at('/test/500').accepts('application/xml').with('Accept-Language' => 'en').get[2].code.should == 500

      @builder.history(0).request[2].code.should == 200
      ...
      @builder.history(1).request[2].code.should == 200
      @builder.path.should == '/test'
      @builder.host.to_s.should == @host
      @builder.headers['Accept'].should == 'text/html'
      @builder.headers['Accept-Language'].should == 'pt-BR'

      @builder.history(2).request[2].code.should == 201
      @builder.path.should == '/test'
      @builder.host.to_s.should == @host
      ...
      @builder.history(3).request[2].code.should == 500
  ...
  context "error conditions" do
    ...
    it "raise Error::Redirection error when 300..399  code is returned" do
      @client.get("/test/302")[2].code.should == 302
    ...
    it "raise Error::BadRequest error when 400 code is returned" do
      @client.get("/test/400")[2].code.should == 400
    ...
    it "raise Error::Unauthorized error when 401 code is returned" do
      @client.get("/test/401")[2].code.should == 401
    ...
    it "raise Error::Forbidden error when 403 code is returned" do
      @client.get("/test/403")[2].code.should == 403
    ...
    it "raise Error::NotFound error when 404 code is returned" do
      @client.get("/test/404")[2].code.should == 404
    ...
    it "raise Error::MethodNotAllowed error when 405 code is returned" do
      @client.get("/test/405")[2].code.should == 405
    ...
    it "raise Error::ProxyAuthenticationRequired error when 407 code is returned" do
      @client.get("/test/407")[2].code.should == 407
    ...
    it "raise Error::Conflict error when 409 code is returned" do
      @client.get("/test/409")[2].code.should == 409
    ...
    it "raise Error::Gone error when 410 code is returned" do
      @client.get("/test/410")[2].code.should == 410
    ...
    it "raise Error::PreconditionFailed error when 412 code is returned" do
      @client.get("/test/412")[2].code.should == 412
   ...
   it "raise Error::ClientError error when 413 code is returned" do
      @client.get("/test/413")[2].code.should == 413
   ...
   it "raise Error::NotImplemented error when 501 code is returned" do
      @client.get("/test/501")[2].code.should == 501
   ...
   it "raise Error::ServerError error when 500 code is returned" do
      @client.get("/test/500")[2].code.should == 500
   ...
   it "raise Error::ServerNotAvailableError error when 503 code is returned" do
      @client.get(nil,nil)[2].code.should == 503
   ...
   it "raise Error::ServerError error when 502..599 code is returned" do
     @client.get("/test/502")[2].code.should == 502
   ...
   it "raise Error::UnknownError error when 600 or bigger code is returned" do
     @client.get("/test/600")[2].code.should == 600
